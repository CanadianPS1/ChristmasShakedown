...
# Character selection — "sally" or "grinch"
var player1_character = "grinch"
var player2_character = "sally"
# 1 = waiting for P1 to pick, 2 = waiting for P2 to pick, 0 = both picked
var selection_phase = 1
