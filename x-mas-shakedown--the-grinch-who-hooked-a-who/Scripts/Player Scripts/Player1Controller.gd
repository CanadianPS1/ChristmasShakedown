...
func _physics_process(delta):
	...
	if Input.is_action_just_pressed("P1Down") and is_on_floor() and crouching == false:
		crouching = true;
	...
	if Input.is_action_just_pressed("P1Kick") && currentAttack == "":
		...
		kick.hide();
		currentAttack = "";
	if Input.is_action_just_pressed("P1Heavie") && currentAttack == "":
		print("P1 Heavied");
		...
		heavie.hide();
		currentAttack = "";
	if Input.is_action_just_pressed("P1Light") && currentAttack == "":
		print("P1 Slashed");
